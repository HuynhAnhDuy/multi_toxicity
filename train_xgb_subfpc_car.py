...
print("📥 Loading data...")
df = pd.read_csv("training_data/x_train_Car.csv")  # Must contain 'SMILES' and 'Label' columns
...
joblib.dump(pipeline, "models/xgb_subfpc_car.joblib")
print("✅ Model saved to: models/xgb_subfpc_car.joblib")
